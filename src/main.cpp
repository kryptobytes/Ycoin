...
uint256 hashGenesisBlock("0x0000000001534ef8893b025b9c1da67250285e35c9f76cae36a4904fdf72c591");//("0x000000000019d6689c085ae165831e934ff763ae46a2a6c172b3f1b60a8ce26f"); // ycoin
CBigNum bnProofOfWorkLimit(~uint256(0) >> 32);
const int nTotalBlocksEstimate = 36500; // Conservative estimate of total nr of blocks on main chain //ycoin
...
unsigned int static GetNextWorkRequired(const CBlockIndex* pindexLast)
{
	...
	bool revisedycoin = pindexLast->nHeight+1 > 20055; //next normal target: 20160
	if (revisedycoin) nTargetTimespan = 24 * 60 * 60; //24 hours i.e. 144 blocks
...
{
    if (pindexBest == NULL || nBestHeight < (GetTotalBlocksEstimate()-nInitialBlockThreshold)) //ycoin was 4006 
        return true;
...
char pchMessageStart[4] = { 0xf1, 0xba, 0xb6, 0xdb }; //new ycoin
